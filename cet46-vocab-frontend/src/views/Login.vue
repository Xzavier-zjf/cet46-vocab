  ...
  <div class="auth-page" :class="{ 'is-dark': isDark }">
    ...
    <div class="login-shell">
      <section class="brand-panel">
        ...
        <h1 class="brand-title">让单词像游戏一样上头</h1>
        <p class="brand-subtitle">输入账号，开启你的记忆闯关模式。</p>
      ...
      <section class="auth-card">
        <div class="title-wrap">
          <h2 class="project-title">欢迎回来</h2>
          <p class="subtitle">登录 CET46 Vocabulary</p>
        </div>
...
const teaserWords = ['abandon', 'resilient', 'meticulous', 'trajectory', 'immersive', 'proficiency']
